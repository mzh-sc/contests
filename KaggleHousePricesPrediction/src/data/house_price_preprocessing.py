...
def create_preprocessing_pipeline() -> Pipeline:
    ...
    pipeline = Pipeline(steps=[
            ('drop_id', p.DropColumns(columns_to_drop=['Id'])), 
            
            ('drop_cols_with_missing_values', p.DropColumns(
                columns_to_drop=['PoolQC', 'MiscFeature', 'Alley', 'Fence', 'FireplaceQu', 'LotFrontage'])),
            
            ('drop_electrical_rows', p.DataFrameFunctionTransformer(
            ...
            ('impute_garage_yr_blt', p.DataFrameFunctionTransformer(impute_garage_yr_blt)),
            ...
            ('replace_values', DataFrameMapper(
                [(key, p.SeriesFunctionTransformer(
            ...
            ('drop_suspicious_columns', p.DropColumns(
